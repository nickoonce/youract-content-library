...
- Prevented recursive metadata filtering in Opportunity archive stage output.

= 1.1.8 =

- Formatted direct theme metadata reads for Opportunity archive stage output.

= 1.1.7 =

- Formatted Opportunity archive stages when themes use a direct `core/post-meta` `metaKey`.

= 1.1.6 =

- Formatted raw Opportunity archive stage metadata as a capitalized `Stage:` label.

= 1.1.5 =

- Added the `Stage:` prefix to Opportunity stage Block Binding output.
...
- Simplified Opportunity details output to the optional action link.
...
- Added the Recommended Publications shortcode and editorial list styling.

= 1.0.15 =

- Added the Recommended Publication renderer and template foundation.

= 1.0.14 =

- Changed Advanced Custom Fields integration to a soft runtime dependency compatible with ACF Free and Pro.

= 1.0.13 =

- Added the Recommended Reading Resource Type and dedicated publications query foundation.

= 1.0.12 =

- Applied Active Resource visibility filtering to the standard Resource archive.

= 1.0.11 =

- Updated generic Resource queries, rendering, administration, templates, dates, and structured data to use the canonical Resource schema.

= 1.0.10 =

- Added the ACF-defined Resource editing interface and canonical Resource metadata schema.

= 1.0.9 =

- Updated Event details template output.
